...
public final class DedupeResult {
  ...
  public DedupeResult(int n,List<SourceRecord> r,List<DuplicateGroup> g,List<InvalidSource> i){
    originalCount=n; retained=Collections.unmodifiableList(new ArrayList<>(r));
    groups=Collections.unmodifiableList(new ArrayList<>(g)); invalid=Collections.unmodifiableList(new ArrayList<>(i));
  }
  public int getOriginalCount(){return originalCount;} public List<SourceRecord> getRetained(){return retained;}
  public List<DuplicateGroup> getDuplicateGroups(){return groups;} public List<InvalidSource> getInvalid(){return invalid;}
