...
public final class DuplicateGroup {
  ...
  public DuplicateGroup(String key,String reason,SourceRecord kept,List<SourceRecord> removed){
    this.key=key;this.reason=reason;this.kept=kept;this.removed=Collections.unmodifiableList(new ArrayList<>(removed));
  }
